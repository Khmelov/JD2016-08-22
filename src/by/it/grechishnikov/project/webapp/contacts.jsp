      ...
      <div class="container">
        ...
        <div class="navbar-collapse collapse">
          <ul class="nav navbar-nav">
                      ...
                      <li><a href="http://localhost:8080/grechishnikov/controller/?command=catalog">Каталог</a></li>
                      <li class="active"><a href="http://localhost:8080/grechishnikov/contacts.jsp">Контакты</a></li>
                    </ul>
