...
CREATE TABLE `ad` (
  ...
  `DoorCount` decimal(10,0) NOT NULL COMMENT 'Количество дверей',
  `Floor` int(11) NOT NULL COMMENT 'Этаж',
  `Floors` int(11) NOT NULL COMMENT 'Этажность дома',
  `Model` varchar(500) NOT NULL COMMENT 'Адрес',
...
INSERT INTO `ad` (`ID`, `RoomCount`, `Price`, `DoorCount`, `Floor`, `Floors`, `Model`, `Description`, `FK_Users`) VALUES
